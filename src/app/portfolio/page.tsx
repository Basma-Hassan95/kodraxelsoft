            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-semibold transition-all duration-300 ${
                selectedCategory === cat
                  ? "bg-teal-600 text-white dark:bg-cyan-600 shadow-md shadow-cyan-500/20"
          ...
          <GSAPReveal key={project.id} direction="up" delay={idx * 0.1}>
            <GlowCard className="h-full flex flex-col justify-between p-6">
              <div>
                ...
                <div className="text-[11px] font-semibold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider mb-1">
                  {project.client}
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 p-3 rounded-lg bg-slate-100 dark:bg-[#090d16] border border-slate-200 dark:border-slate-800 mb-4">
                  {project.impactMetrics.map((metric, mIdx) => (
                    <div key={mIdx} className="text-center">
                      <div className="text-xs font-extrabold text-cyan-600 dark:text-cyan-400">{metric.value}</div>
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-3 p-4 rounded-xl bg-slate-100 dark:bg-[#090d16] border border-slate-200 dark:border-slate-800">
              ...
              <h4 className="text-xs font-bold uppercase tracking-wider text-cyan-600 dark:text-cyan-400 pt-2">
