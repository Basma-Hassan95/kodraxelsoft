    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          {/* Logo Section - Subtitle Removed, Crisp Typography */}
          <Link href="/" className="flex items-center gap-2.5 group focus:outline-none">
            <div className="relative w-9 h-9 rounded-xl bg-gradient-to-br from-teal-600 via-cyan-500 to-sky-500 flex items-center justify-center text-white shadow-md shadow-cyan-500/25 group-hover:scale-105 transition-transform duration-300">
              <Layers className="w-5 h-5 text-white" />
              <div className="absolute inset-0 rounded-xl bg-cyan-400 opacity-0 group-hover:opacity-30 blur-sm transition-opacity" />
            </div>
          ...
          {/* Desktop Navigation Links - High Contrast & Teal Hover Highlight */}
              ...
              return (
                <Link
                  ...
                  className={`relative px-3.5 py-1.5 rounded-full text-xs transition-all duration-300 ${
                    isActive
                      ? "text-white bg-gradient-to-r from-teal-600 to-cyan-600 font-bold shadow-md shadow-cyan-500/20 border border-cyan-400/30"
                      : "text-slate-800 dark:text-slate-200 font-semibold hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-slate-300/50 dark:hover:bg-slate-800/70"
                  }`}
                >
                  {link.name}
                </Link>
